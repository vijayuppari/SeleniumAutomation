...
public class parallelexecutionwithstaticdriver {
    ...
    public void launchdriver(){
       ...
       // driver = new ChromeDriver();
        driverThreadLocal.get().get("https://www.saucedemo.com/v1/");
    }
    ...
    public void testLogin1(){
        ...
        driverThreadLocal.get().findElement(By.id("login-button")).click();
    }

    @Test
    public void testLogin2(){
        driverThreadLocal.get().findElement(By.id("user-name")).sendKeys("performance_glitch_user");
        driverThreadLocal.get().findElement(By.id("password")).sendKeys("secret_sauce");
        driverThreadLocal.get().findElement(By.id("login-button")).click();
    }
